# Generated by Django 3.2 on 2025-04-07 09:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(help_text='Год создания произведения', validators=[reviews.validators.validate_year], verbose_name='Год создания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.SmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Оценка на может быть меньше 1'), django.core.validators.MaxValueValidator(10, 'Оценка на может быть больше 10')])),
